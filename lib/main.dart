...
Future<List<Mhs>> fetchMhss(http.Client client) async {
  final response =
      await client.get('https://helloenifflutter.000webhostapp.com/readDatajson.php');
...
Future<bool> updateEmployee(nim, nama, kelas, kdmatkul, email) async {
    final url = 'https://helloenifflutter.000webhostapp.com/editDatajson.php';
...
Future<void> deleteEmployee(String nim) async {
    final url = 'https://helloenifflutter.000webhostapp.com/deleteDatajson.php';
...
return Container(
            ...
            child: ButtonBar(
              children: <Widget>[
                ...
                FlatButton(
                  ...
                  onPressed: () {
                        showAlert(context, data[index].nim);
                  },
                ),
              ],
            ),
    ...
    showAlert(BuildContext context,String nim) {
    showDialog(
    context: context,
